...
/*   Updated: 2024/07/27 17:52:29 by ytoshihi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	wasd_key_hook(t_data *data, int *step)
{
	...
	data->map->instances[0].x = 100 - data->x;
	data->map->instances[0].y = 100 - data->y;
	data->direction->instances[0].x = 100 + cos(data->angle) * data->side;
	data->direction->instances[0].y = 100 + sin(data->angle) * data->side;
}
